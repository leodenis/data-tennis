...
(function($){
	$.movingBoxes = function(el, options){
		...
		base.change = function(curPanel, callback, flag){
			...
			if (curPanel == 1) {
				var change = document.getElementById("contentPlayerNameDjoko"); 
				change.className="look";

				var change = document.getElementById("contentPlayerNameMurray"); 
				change.className= "hide"; 
			}

			else if(curPanel == 2){
				var change = document.getElementById("contentPlayerNameRoger"); 
				change.className= "hide"; 
				...
				var change = document.getElementById("contentPlayerNameRoger"); 
				change.className= "look"; 
				var changeok = document.getElementById("contentPlayerNameNadal"); 
				changeok.className= "hide"; 
				// document.getElementById("imgDjoko").style.marginLeft="-45px"; 

			}

			else if(curPanel == 4){

				var changeok = document.getElementById("contentPlayerNameRoger"); 
				changeok.className= "hide"; 

				var changeok = document.getElementById("contentPlayerNameNadal"); 
				changeok.className= "look"; 
				var change = document.getElementById("contentPlayerNameFerrer"); 
				change.className= "hide"; 
			}

			else if(curPanel == 5){
				var change = document.getElementById("contentPlayerNameNadal"); 
				change.className= "hide"; 

				var change = document.getElementById("contentPlayerNameFerrer"); 
				change.className= "look"; 

				var berdych = document.getElementById("contentPlayerNameBerdych"); 
				berdych.className= "hide"; 
			}


			else if(curPanel == 6){

				var ferrer = document.getElementById("contentPlayerNameFerrer"); 
				ferrer.className= "hide"; 

				var berdych = document.getElementById("contentPlayerNameBerdych"); 
				berdych.className= "look"; 

				var potro = document.getElementById("contentPlayerNamePotro"); 
				potro.className= "hide"; 
			}
			else if(curPanel == 7){
				...
				var potro = document.getElementById("contentPlayerNamePotro"); 
				potro.className= "look"; 

				var tsonga = document.getElementById("contentPlayerNameTsonga"); 
				tsonga.className= "hide"; 
			}
			else if(curPanel == 8){
				...
				var tsonga = document.getElementById("contentPlayerNameTsonga"); 
				tsonga.className= "look"; 

				var gasquet = document.getElementById("contentPlayerNameGasquet"); 
				gasquet.className= "hide"; 
			}
			else if(curPanel == 9){
				...
				var gasquet = document.getElementById("contentPlayerNameGasquet"); 
				gasquet.className= "look"; 


				var wawr = document.getElementById("contentPlayerNameWawrinka"); 
				wawr.className= "hide"; 
				...
				var lool = document.getElementById("contentPlayerNameWawrinka"); 
				lool.className= "look"; 

				var kikk = document.getElementById("contentPlayerNameDjoko"); 
				kikk.className="hide";
			}
			if (base.initialized) {
	...
	$.movingBoxes.defaultOptions = {
		...
		panelWidth   : 0.1,       // current panel width adjusted to 50% of overall width
		reducedSize  : 0.4,       // non-current panel size: 80% of panel size
